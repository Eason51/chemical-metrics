        ...
        if 'Phase 1' in i['Phase'] and 'Phase 2' in i['Phase']:
            if i['OverallStatus'][0] == 'Not yet recruiting':
                ...
                if i['OverallOfficialAffiliation']:
                    ...
                    if i['EventGroupSeriousNumAffected'] and i['EventGroupSeriousNumAtRisk'] and i['EventGroupSeriousNumAtRisk'][0] != 0 and company not in list(statistics['p2_adverse_event']):
            ...
            if i['OverallStatus'][0] == 'Not yet recruiting':
                ...
                if i['OverallOfficialAffiliation']:
                    ...
                    if i['EventGroupSeriousNumAffected'] and i['EventGroupSeriousNumAtRisk'] and i['EventGroupSeriousNumAtRisk'][0] != 0 and company not in list(statistics['p3_adverse_event']):
                ...
                if i['OverallOfficialAffiliation']:
                    ...
                    if company not in list(p3_stat7_company.keys()):
                        ...
                        if i['EventGroupSeriousNumAffected'] and i[
                            'EventGroupSeriousNumAtRisk'] and i['EventGroupSeriousNumAtRisk'][0] != 0 and company not in list(statistics['p3_adverse_event']):
            ...
            if i['OverallStatus'][0] == 'Not yet recruiting':
                ...
                if i['OverallOfficialAffiliation']:
                    ...
                    if i['EventGroupSeriousNumAffected'] and i['EventGroupSeriousNumAtRisk'] and i['EventGroupSeriousNumAtRisk'][0] != 0 and company not in list(statistics['p1_adverse_event']):
                    ...
                    if company not in list(p1_stat7_company.keys()):
                        ...
                        try:
                            ...
                            p1_stat7_company[company].append(
                                datetime.datetime.strptime(i['CompletionDate'][0], '%B %Y'))
                        if i['EventGroupSeriousNumAffected'] and i[
                            'EventGroupSeriousNumAtRisk'] and i['EventGroupSeriousNumAtRisk'][0] != 0 and company not in list(statistics['p1_adverse_event']):
