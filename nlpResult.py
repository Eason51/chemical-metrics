...
def all_to_json(targetName, fileAmount):
    ...
    for articleURL in tableAddressArr:
        ...
        pickleItem = {}
        pickleItem["doi"] = article.doi
        pickleItem["tableParser"] = article.tableParser
        pickleItem["nlpDict"] = article.nlpDict
        pickleArr.append(pickleItem)
    ...
    print(5)
    [secondValueArr, thirdValueArr] = paper_count_per_year.get_paper_count_per_year(targetName.lower())
    ...
    with open("nlpResult.pickle", "wb") as outputFile:
        pickle.dump(pickleArr, outputFile, protocol=pickle.HIGHEST_PROTOCOL)
